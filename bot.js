...
(function () {
    ...
    var basicBot = {
        ...
        chatLink: "https://rawgit.com/strajodtwert/bot/master/srb.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            skipReasons: [
                ...
                ["history", "Tvoja pesma je u istoriji. "],
            ...
            youtubeLink: null,
            website: "https://strajosrb.wixsite.com/mysite",
            intervalMessages: [],
            messageInterval: 5,
            songstats: false,
            commandLiteral: "!",
        ...
        startup: function () {
            ...
            if (basicBot.settings.startupEmoji) {
                ...
                API.chatLog(':smile: Emojis disabled.');
            }
            else {
